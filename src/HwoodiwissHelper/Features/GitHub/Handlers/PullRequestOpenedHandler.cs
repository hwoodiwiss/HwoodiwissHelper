...
public sealed partial class PullRequestOpenedHandler(IGitHubService gitHubService, IOptions<GitHubConfiguration> githubOptions, ILogger<PullRequestOpenedHandler> logger, ActivitySource activitySource) : Features.GitHub.Handlers.GithubWebhookRequestHandler<PullRequest.Opened>(logger, activitySource)
{
