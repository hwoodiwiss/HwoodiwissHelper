...
public sealed partial class PullRequestSynchronizeHandler(IGithubService githubService, IOptions<GithubConfiguration> githubOptions, ILogger<PullRequestOpenedHandler> logger, ActivitySource activitySource) : GithubWebhookRequestHandler<PullRequest.Synchronize>(logger, activitySource)
{
